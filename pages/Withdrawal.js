    ...
    return(
        <div>
            <Flex direction="column" h="100%" bg="#FAFAFA">
                <Flex w="vw" h="40px" justifyContent="center" alignItems="center" bg="white" border="1px solid #DDDDDD">
                    <Text fontSize={f1} color={fc2} fontWeight="bold" align="center">회원탈퇴</Text>
                    <Link href='/Profile' position="absolute" left="11px" w="20px" h="20px">
                        <Image src={arrowL} alt="arrowL"/>
                    </Link>
                </Flex> 

                <Flex w="vw" h="120px" direction="column" alignItems="center" justifyContent="center" mb="10px" bg="white">
                    <Flex w="50px" h="50px">
                        <Image src={user} alt="user"/>
                    </Flex>
                    <Text fontSize={f2} color={fc2} fontWeight="bold" mt="4px" mb="4px" letterSpacing="-1px">유저닉네임</Text>
                </Flex>

                <Flex h="92px" bg="white">
                    <Spacer/>
                        <Flex w="67px" direction="column" justifyContent="center">
                            <Link href='/Willgo'>
                                <Text fontSize={f1} color={fc2} fontWeight="bold" align="center">999</Text>
                                <Text fontSize="10px" align="center" color={fc5}>작성후기</Text>
                            </Link>
                        </Flex>
                        <Flex w="67px" direction="column" justifyContent="center">
                            <Link href='/Went'>
                        ...
                        <Flex w="67px" direction="column" justifyContent="center">
                            <Link href='/Review'>
                                <Text fontSize={f1} color={fc2} fontWeight="bold" align="center">999</Text>
                                <Text fontSize="10px" align="center" color={fc5}>정보수정</Text>
                            </Link> 
                        </Flex>
                        <Flex w="67px" direction="column" justifyContent="center">
                            <Link href='/Like'>
                                <Text fontSize={f1} color={fc2} fontWeight="bold" align="center">완료</Text>
                                <Text fontSize="10px" align="center" color={fc5}>입맛테스트</Text>
                            </Link>
                        </Flex>
                    <Spacer/>
                </Flex>

                <Flex justifyContent="center" mt="10px" bg="white">
                    <Text bg="#F6E229" fontSize={f2} color={fc2} fontWeight="bold" mt="40px" mb="10px">
                        회원 탈퇴 전 아래 내용을 꼭! 확인해 주세요!
                    </Text>
                </Flex>

                <Flex direction="row" p="10px" alignItems="flex-start" bg="white">
                    {Check1?
                ...
                <Flex direction="row" p="10px" alignItems="flex-start" pt="10px" bg="white">
                    {Check2?
                    ...
                    <Flex direction="column" position="sticky" mr="10px"  w="100%" bottom="0"  mt="30px" pb="20px" is>
                        <Flex  w="100%" h="40px">
                            <Link href='/' w="100%" mr="10px" ml="10px">
                                <Button w="100%" borderRadius="full" bg="#F6E229" color={fc1} fontWeight={700} fontSize={f1}>탈퇴하기</Button>
                            </Link>
                        </Flex>
                    </Flex>
                :
                    <Flex direction="column" position="sticky" mr="10px"  w="100%" bottom="0"  mt="30px" pb="20px" is>
                        <Flex  w="100%" h="40px">
                            <Link href='/' w="100%" mr="10px" ml="10px">
                                <Button w="100%" borderRadius="full" bg="#F6E229" color={fc1} fontWeight={700} fontSize={f1} isDisabled>탈퇴하기</Button>
                            </Link>
                        </Flex>
                    </Flex>
                }
